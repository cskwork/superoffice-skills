...
- **회사 브랜드 반영.** 회사 템플릿 파일 상속(`Presentation("회사.pptx")`)과 brand-kit.json 인터뷰(색/폰트/로고/정책)를 둘 다 지원한다. 한 번 캡처하면 모든 형식·문서에 일관 적용되고, 회사 색도 WCAG AA 대비를 지킨다(`reference/brand-kit.md`).
